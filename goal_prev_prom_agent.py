...
def create_agent_with_behaviors() -> Agent:
    # Create needs
    ...
    eat_goal = Goal("Eat", -0.5, {survival: 1.0})
    socialize_goal = Goal("Socialize", 0.7, {social: 0.7, achievement: 0.3})
    work_goal = Goal("Work", 0.2, {achievement: 0.8, survival: 0.2})
...
def run_simulation(agent: Agent, num_days: int):
